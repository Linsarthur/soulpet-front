...
function NovoCliente() {
  ...
  function salvarCliente(data) {
    addCliente(data).then((resposta) => {
      //'Resposta'representa o corpor de resposta que o back-end retornou para o front com a mensagem de sucesso.
      toast.success(resposta.message)
      navigate("/clientes")
    }).catch((err) => {
      //caso ocorra algum erro usamos o cath para tratar
